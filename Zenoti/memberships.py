...
TABLE = os.getenv("TABLE_MEMBERSHIPS")
CSV_FILE = os.getenv("CSV_FILE_MEMBERSHIPS")
...
if CSV_SOURCE == "gdrive":
    ...
    CSV_FILE = get_csv_from_gdrive(
        os.getenv("GDRIVE_FOLDER_MEMBERSHIPS"),
...
if not CSV_FILE:
    print("SKIP: No CSV file available for memberships. Exiting.")
    exit(0)
...
for csv_path in csv_paths:
    ...
    MANUAL_MAP = {
        ...
        "Sales": "sales_amount",
        "Sales(Inc. Tax)": "sales_amount_inc_tax",
        "Benefit": "benefit_amount",
        "Redeemed Value": "redeemed_value",
        "Cancelled Value": "cancelled_value",
        "Expired Value": "expired_value",
        "Suspense": "suspense_value",
        "Balance Value": "balance_value",
        "Membership Status": "membership_status",
        "Recurrence Status": "recurrence_status",
        "Next Recurrence Date": "next_recurrence_date",
        ...
        "Unfreeze Date": "unfreeze_date",
        "Refund Amount": "refund_amount",
        "Last Refunded Invoice #": "last_refunded_invoice_no",
        "Recurrence Cycle #": "recurrence_cycle_no",
        "Membership Termination Date": "membership_termination_date",
        "Recurrence Cancellation Date": "recurrence_cancellation_date",
        "Redemption Post Expiry": "redemption_post_expiry",
        "Membership Renewal": "membership_renewal",
        "Add On Members#": "add_on_members_count",
        "Reason for membership expiration": "membership_expiration_reason",
    }
    ...
    # ==================================
    currency_date_columns = {
        "sale_date", "start_date", "next_recurrence_date",
        "freeze_date", "unfreeze_date", "membership_termination_date",
        "recurrence_cancellation_date"
    }
