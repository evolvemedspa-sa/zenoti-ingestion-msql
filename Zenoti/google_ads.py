...
TABLE = os.getenv("TABLE_GOOGLE_ADS")
CSV_FILE = os.getenv("CSV_FILE_GOOGLE_ADS")
DB_USER = os.getenv("DB_USER")
DB_PASSWORD = os.getenv("DB_PASSWORD")

CSV_SOURCE = os.getenv("CSV_SOURCE", "local").lower()
if CSV_SOURCE == "gdrive":
    print("Checking Google Drive for Google Ads CSV files...")
    from gdrive_helper import get_csv_from_gdrive
    CSV_FILE = get_csv_from_gdrive(
        os.getenv("GDRIVE_FOLDER_GOOGLE_ADS"),
...
# ==================================
if not CSV_FILE:
    raise ValueError("CSV_FILE_GOOGLE_ADS must be set in the .env and point to a file or directory")
...
MATCH_KEY_NAMES = ["report_date", "campaign_id"]
match_key_cols = []
...
for csv_path in csv_paths:
    ...
    MANUAL_MAP = {
        ...
        "Conversions: All conversions": "all_conversions",
        "Conversions: Conversions": "conversions",
        "Cost: Cost per conversion": "cost_per_conversion",
        "Campaign: Campaign status": "campaign_status",
        "Campaign: Start date": "campaign_start_date",
        "Campaign: End date": "campaign_end_date",
        "Campaign: Advertising channel type": "advertising_channel_type",
        "Campaign: Tracking URL template": "tracking_url_template",
        "Campaign: Budget amount": "budget_amount",
    }
    ...
    google_ads_date_columns = {"report_date", "campaign_start_date", "campaign_end_date"}
    for col in df.columns:
        if normalize_col(col) in google_ads_date_columns:
